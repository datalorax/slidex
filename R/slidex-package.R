...
#'  it should get you about 90% of the way there for about 80% of use
...
#'  completed to get the HTML slides to look "perfect", but most of the hard
#'  work should be done for you. Importantly, the package maintains and
#'  provides the proper code for any images that were embedded in the PPTX
